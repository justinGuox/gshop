    ...
    <div class="ratings-content">
      <div class="overview">
        ...
        <div class="overview-right">
          ...
          <div class="delivery-wrapper" style="
    height: 30px"><span class="title">送达时间</span> <span class="delivery">{{info.deliveryTime}} 分钟</span></div>
        </div>
      </div>
      <div class="split"></div>
      <div class="ratingselect">
        <div class="rating-type border-1px">
          <span class="block positive" :class="{active: selectType===2}" @click="setSelectType(2)">全部<span class="count">{{ratings.length}}</span>
          </span>
          <span class="block positive" @click="setSelectType(0)" :class="{active: selectType===0}">满意
            <span class="count">{{positiveSize}}</span>
          </span>
          <span class="block negative" @click="setSelectType(1)" :class="{active: selectType===1}"> 不满意<span class="count">{{ratings.length-positiveSize}}</span>
        </span>
        </div>
          ...
          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
            ...
            <div class="content"><h1 class="name">{{rating.username}}</h1>
              ...
              <div class="recommend"><span class="iconfont"
                                           :class="rating.rateType === 0 ? 'icon-tuijian' : 'icon-tucao-tianchong'"></span>
